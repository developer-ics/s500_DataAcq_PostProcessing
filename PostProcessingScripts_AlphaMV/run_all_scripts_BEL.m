...
if inpar_ent=='y'
  ...
  %  inpar=[pwd '\InputParamMV_Oct17_2024.txt']
...
if enable_S4
    ...
    s4_Set_start_end_time_sync_BEL
else
    disp("Skipped Step 4")
...
%
include_beach_rover=str2num(cell2mat(T2.include_beach_rover(2)))
if include_beach_rover
    beach_rover_data_path=char(T2.beach_rover_data_path(2))
end
