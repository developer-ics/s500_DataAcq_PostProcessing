...
gps_ind_st=near(PPKGPS.datetime_ppk_g,start_time);
gps_ind_en=near(PPKGPS.datetime_ppk_g,end_time);
...
lati=interp1(fillmissing(PPKGPS.datetime_ppk_g,'linear'),PPKGPS.lat_ppk,sonar_dtime_utc_gps(sonar_ind));
loni=interp1(fillmissing(PPKGPS.datetime_ppk_g,'linear'),PPKGPS.lon_ppk,sonar_dtime_utc_gps(sonar_ind));
