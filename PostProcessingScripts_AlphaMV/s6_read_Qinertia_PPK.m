...
file_name=[ppk_gpsdata_pos_path]
...
height_datum_ppk=T2p.AltitudeMSL;
...
subplot(311)
plot(datetime_ppk,T2p.AltitudeMSL,'.-b')
hold on
...
mkdir(odir)
save([odir 's6_PPK_GNSS_DATA_' fs2],'lon_ppk','lat_ppk','clean_height_datum_ppk','q1_clean_height_datum_ppk','datetime_ppk_g','height_datum_ppk')
